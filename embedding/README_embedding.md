...
Thư mục `embedding` hiện có các file:

- `embed_texts.py`
- `batch_embed_texts.py`

Tính tới thời điểm cập nhật này, cả hai file đều đang rỗng và chưa được phát triển.

## File Tài Liệu Trong Thư Mục

### `README_embedding.md`

File này mô tả trạng thái hiện tại của thư mục `embedding` và từng file trong thư mục.
